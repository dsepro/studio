        ...
        <CardContent className="flex-grow flex flex-col items-center justify-center space-y-4 px-4 py-2">
          ...
          <div className="flex justify-center space-x-2 sm:space-x-3 w-full max-w-xs pt-2">
            <Button 
              ...
              className="flex-1 text-xs py-2 h-8 bg-primary text-primary-foreground hover:bg-primary/90"
              size="sm"
            >
               {T.start}
            </Button>
            <Button 
              ...
              disabled={!isRunning} 
              variant="secondary" 
              className="flex-1 text-xs py-2 h-8 bg-secondary text-secondary-foreground hover:bg-secondary/80"
              size="sm"
            >
               {T.stop}
            </Button>
            <Button 
              onClick={handleReset} 
              variant="destructive" 
              className="flex-1 text-xs py-2 h-8 bg-destructive text-destructive-foreground hover:bg-destructive/90"
              size="sm"
            >
               {T.reset}
            </Button>
